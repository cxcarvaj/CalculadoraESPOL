...
final class CalculadoraEspolPreviewContainer {
    ...
    func loadSubjects() throws {
        ...
        subjectDTO.map {
            SubjectDataSchemeV1.SubjectData(name: $0.name, theoricalPercentage: $0.theoricalPercentage, firstPartialGrade: $0.firstPartialGrade, secondPartialGrade: $0.secondPartialGrade, practicalGrade: $0.practicalGrade, improvementGrade: $0.improvementGrade, totalGrade: $0.totalGrade)
